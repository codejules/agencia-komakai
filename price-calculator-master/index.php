        ...
        <fieldset id="product-summary">
            ...
            <div class="row">
                <div class="item">
                    ...
                    <div class="order">
                        <label for="paginas">Quantity Desired: </label>
                        <input type="number" name="paginas" id="paginas" min="0" placeholder="0" size="3" >
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="item">     
                    ...
                    <div class="order">
                        <label for="seo">Quantity Desired: </label>
                        <input type="number" name="seo" id="seo" min="0" placeholder="0" size="3" >
                    </div>
                </div>
